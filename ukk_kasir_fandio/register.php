                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="text" name="nama" placeholder="Nama lengkap" required/>
                                            ...
                                            <div class="form-floating mb-3">
                                            <input type="radio" name="level" id="admin" value='admin' required>Admin
                                            <input type="radio" name="level" id="petugas" value='admin'>Petugas
                                            </div>
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><p>Sudah punya akun?</p><a href="login.php">Login!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
