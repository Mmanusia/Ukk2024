                        ...
                        <table id="datatablesSimple">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-danger" href="delete_produk.php?id_produk=<?php echo $d['id_produk']; ?>">delete</a> 
                                        <a class="btn btn-primary" href="edit_produk.php?id_produk=<?php echo $d['id_produk']; ?>">edit</a></td>
                                </tr>
                                <?php
                                }
                                ?>
